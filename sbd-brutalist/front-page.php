...
<main class="wrap">
  ...
  <section class="section">
    <h2>No More Noise</h2>
    <p>Most apps try push rigid systems wrapped in technology. We're here to give you a flexible process to support your goals.</p>

    <p>Savage by Design isn't just for lifting (though your in right place if your goal) — it's an experience engineering platform.</p>
